  ...
  return (
    <div className="group bg-zinc-800 rounded-2xl p-8 hover:bg-tall-poppy-600 transition-all duration-300 border border-zinc-700 hover:border-tall-poppy-500">
      <div className="w-16 h-16 bg-tall-poppy-600 rounded-xl flex items-center justify-center mb-6 group-hover:bg-white group-hover:scale-110 transition-all">
        <div className="text-white group-hover:text-tall-poppy-500">{icon}</div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-zinc-700 leading-relaxed">
              <p>
                For more than two decades, Roofers Group of Companies has built
                a strong reputation as a trusted name in the UAE construction
                industry. With over 24 years of experience, we have grown into a
                multi-disciplinary enterprise, bringing expertise, reliability,
                and quality to every project we undertake.
              </p>
              <p>
                Our core strengths lie in Roof Tiles, as well as Steel,
                Aluminium, and Stainless-Steel Fabrication and Erection,
                supported by a wide range of Civil Contracting services. Backed
                by fully equipped workshops and skilled teams in Dubai, Abu
                Dhabi, and Ajman, we deliver complete structural and finishing
                solutions for commercial, industrial, and high-end residential
                projects.
              </p>
              <p>
                Beyond contracting, Roofers Group also connects the UAE market
                with the world. Through our partner factories in Italy, Spain,
                China, Brazil, and the USA, we manufacture and supply
                premium-quality products, ensuring our clients benefit from
                international standards at competitive value.
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-zinc-200 hover:shadow-xl transition-shadow">
            ...
            <p className="text-zinc-600 leading-relaxed">
              State-of-the-art workshops in Dubai, Abu Dhabi, and Ajman equipped
              for steel, aluminium, and stainless-steel fabrication with
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-zinc-200 hover:shadow-xl transition-shadow">
            ...
            <p className="text-zinc-600 leading-relaxed">
              Strategic partnerships with factories in Italy, Spain, China,
              Brazil, and USA ensuring premium materials and international
              quality standards.
            </p>
          </div>
        </div>
