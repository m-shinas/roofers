  ...
  <div>
    <div className="relative w-full h-screen bg-gradient-to-b from-[#0c0333]/30 to-[#0c0333]/30 py-0 flex items-center justify-start ">
      ...
      <div className="ml-[5%]">
        ...
        <Link
          href="/contact"
          className={` ${mulish.className} inline-block text-center text-white bg-gradient-to-r from-tall-poppy-600 to-tall-poppy-700 rounded-4xl hover:rounded-lg focus-visible:rounded-lg transition-[border-radius] duration-400 ease text-[24px] py-[14px] px-[42px] mt-[20px] shadow-lg cursor-pointer`}
        >
          Get a Quote
        </Link>
      </div>
